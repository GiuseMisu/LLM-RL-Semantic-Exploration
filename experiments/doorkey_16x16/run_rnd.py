"""
Train RND-PPO (Curiosity-Driven) on DoorKey-16x16 environment
Final experimental
"""
...
def main():
    ...
    # Train
    print(f"\n{'='*60}")
    print(f"Starting RND-PPO training on DoorKey-16x16")
    print(f"{'='*60}\n")
    ...
    move_experiment_files("RNDPPO", "DOORKEY_16x16")
