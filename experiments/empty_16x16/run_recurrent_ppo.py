"""
Train RecurrentPPO (with LSTM) on empty16x16 environment
...
def main():
    ...
    # Train
    print(f"\n{'='*60}")
    print(f"Starting RecurrentPPO training on empty_16x16")
    print(f"{'='*60}\n")
    ...
    move_experiment_files("RecurrentPPO_lstm", "EMPTY_16x16")
